...
const cards = [
    ...
    { title: 'Classic & Elegance', copy: 'Classic &  elegance style aims for elegant and luxurious looks. By using classic designs and premium materials ', button: 'show Book', navigateTo: '/classic' }
];
